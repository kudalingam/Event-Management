    ...
    <div class="container" style="margin-left: -10px;">
      ...
      <li class="btn">
        ...
        <?php while($rows=mysqli_fetch_assoc($result)) 
                                            { 
                                            ?>
      <li class="profile"><i><p style="color:red"> Hi.. <?php echo $rows['Username']; ?> </p></i> </li><?php } ?>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <li class="btn"><a href="logout.php" style="left:50px; top:8px;">
          <span></span>
          <span></span>
          <span></span>
          <span></span>
      ...
      <li class="btn" ><a href="profile.php" style="border-radius:100%; left:30px;"><span></span><span></span><span></span><span></span><i class="fas fa-user-circle fa-2x"></i></a></li>
    </ul>
      </div>
    </div>
  </nav><br><br><br>
