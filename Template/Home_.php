...
<body>
  ...
  <div class="container-fluid">
    ...
    <?php while($rows=mysqli_fetch_assoc($result)) 
                                            { 
                                            ?>
      <li class="profile"><i><p> Hi.. <?php echo $rows['Username']; ?> </p></i> </li>
      <li><a href=""></a></li>
      <li><a href=""></a></li>
    <li class="btn"><a href="logout.php" style="border-color: white;"><span ><i class="fas fa-sign-out-alt"></i> LOGOUT</span></a>    
    <li><a href="profile.php">&nbsp;<i class="fas fa-user-circle fa-2x"></i></a></li>
