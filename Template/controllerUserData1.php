...
if(isset($_POST['submit'])){
    ...
    $cpassword = mysqli_real_escape_string($con, $_POST['repass']);
    if($password !== $repass){
    ...
    if(isset($_POST['check'])){
        ...
        if(mysqli_num_rows($code_res) > 0){
            ...
            if($update_res){
                ...
                $_SESSION['Email'] = $email;
                header('location: Location:http://localhost/login/Home.php');
                exit();
            }else{
   ...
   /* if(isset($_POST['login'])){
    ...
    if(isset($_POST['login'])){
        ...
        $query=mysqli_query($con,"select * from usertable where Email='$email' and Password='$encpass'");
