        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <!--div class="input-group">
                    ...
                    <div class="my-2"></div>
                  <a href="index1.php" class="btn btn-info btn-icon-split">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="indexv1.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Dashboard
                            </a>
                            <a class="nav-link" href="usersv1.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-user-circle"></i></div>
                                User Profile
                            </a>
                            <a class="nav-link" href="companyv1.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-users"></i></div>
                                Company Profile
                            </a>
                            <a class="nav-link" href="employeev1.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-user-tie"></i></div>
                                Employee Profile
                            </a>
                            <a class="nav-link" href="adminv1.php">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="indexv.php"><i class="fas fa-adjust"> </i> &nbsp;Dark Mode</a>
                                    <a class="nav-link" href="indexv1.php"><i class="far fa-moon"> </i> &nbsp;Light Mode</a>
                                </nav>
                            </div>
...
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-primary shadow h-100 py-2">
    ...
    <div style="background:steelblue;" class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="usersv1.php">View Details <i class="fas fa-info-circle"></i></a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
  </div>
</div>
...
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-success shadow h-100 py-2">
    ...
    <div style="background:seagreen;" class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href=companyv1.php>View Details <i class="fas fa-info-circle"></i></a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
  </div>
</div>
      ...
      <div class="row no-gutters align-items-center">
        ...
        <div class="col-auto">
          <i class="fas fa-user-tie fa-2x text-gray-300"></i>
                                        ...
                                        <a class="small text-white stretched-link" href="employeev1.php">View Details <i class="fas fa-info-circle"></i></a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
  </div>
</div>
...
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-warning shadow h-100 py-2">
    ...
    <div style="background:orange;" class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="queryv1.php">View Details <i class="fas fa-info-circle"></i></a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
  </div>
</div>
 ...
 ?>  
           ...
           <div style="width:900px; align-content">  
                <h3 align="center"><u>Order</u></h3>  
                <div id="piechart" style="width: 900px; height: 500px;"></div>  
           </div> 
        </div>
        <div class="container-fluid">
           <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Employee Role</li>
                        </ol>
     <?php  
 $connect = mysqli_connect("localhost", "root", "", "login");  
 $sql = "SELECT Role, count(*) as number FROM employee GROUP BY Role";  
 $result = mysqli_query($connect, $sql);  
 ?>  
