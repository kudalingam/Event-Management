...
#toggle1{
    ...
    width: 25px;
    height: 25px;
    background: url(img1/show.png);
    background-size: cover;
    cursor: pointer;
}
#toggle1.hide{
	background: url(img1/hide.png);
    background-size: cover;
		...
		<div class="login-content">
			<form action="sign.php" method="POST">
				...
				<?php
                    if(count($errors) == 1){
                        ?>
                        <div class="alert alert-danger text-center" style="color:red"><br>
                            <?php
                        ...
                        ?>
                        <div class="alert alert-danger" style="color:red"><br>
                            <?php
                            foreach($errors as $showerror){
                                ?>
